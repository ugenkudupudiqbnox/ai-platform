...
| `ar_file_intake.json` | `ar_file_intake` — the **wired** File Intake Flow: `FileIntakeFlowComponent` (real LangGraph) + `File` + `ChatInput`/`ChatOutput` (4 nodes / 3 edges). The 3rd subflow (architecture §4 row 3). See [docs/file-intake.md](../docs/file-intake.md) and [ADR-0004](../docs/adr/adr-0004-file-intake-flow.md). |
